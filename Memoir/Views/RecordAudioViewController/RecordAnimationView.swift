...
class RecordAnimationView: UIView, CAAnimationDelegate {
    ...
    fileprivate func setup() {
        ...
        rectLayer.backgroundColor = RecordAnimationView.buttonMainColor.cgColor
    ...
    fileprivate func animateForm(_ cRadiusFrom: CGFloat, cRadiusTo: CGFloat, scaleFrom: CGFloat, scaleTo: CGFloat) -> CAAnimationGroup {
        ...
        a1.duration = 0.5
        a1.timingFunction = CAMediaTimingFunction(name: CAMediaTimingFunctionName.easeOut)
        ...
        g.duration = 0.5
        g.animations = [a1, a2]
        g.fillMode = CAMediaTimingFillMode.forwards
